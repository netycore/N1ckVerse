...
class NameDatabase(context: Context) {
    ...
    operator fun get(code: Int, column: String): String? {
        if (column == "name") {
            ...
            if (code in 0x3400..0x4DBF || code in 0x4E00..0x9FFF || code in 0x20000..0x2A6DF || code in 0x2A700..0x2B81D || code in 0x2B820..0x2CEAD || code in 0x2CEB0..0x2EBE0 || code in 0x2EBF0..0x2EE5D || code in 0x30000..0x3134A || code in 0x31350 .. 0x33479) return "CJK Unified Ideograph"
    ...
    fun getInt(code: Int, column: String): Int {
        if (column == "version") {
            ...
            if (code in 0x187F8..0x187FF || code in 0x18D09..0x18D1E || code in 0x2B73A..0x2B73F || code in 0x2CEA2..0x2CEAD || code in 0x323B0..0x33479) return 1700
        }
