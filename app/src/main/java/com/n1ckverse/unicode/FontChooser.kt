        ...
        spinner.onItemSelectedListener = object : OnItemSelectedListener {
            ...
            override fun onItemSelected(parent: AdapterView<*>, view: View?, position: Int, id: Long) {
                ...
                when (position) {
                    ...
                    1 -> {
                        // Use the modern launcher wired up in UnicodeActivity
                        (activity as? UnicodeActivity)?.fontFileLauncher?.launch(arrayOf("*/*"))
                            ?: run { spinner.setSelection(if (fontIndex == 0) 0 else fontIndex + 2) }
                    }
                    2 -> {
