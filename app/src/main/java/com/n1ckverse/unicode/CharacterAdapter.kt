...
// Helper: resolve a theme color attribute into an ARGB int
private fun resolveThemeColor(activity: android.app.Activity, attr: Int): Int {
    val tv = TypedValue()
...
internal class CharacterAdapter(private val activity: UnicodeActivity, private val adapter: UnicodeAdapter, private var typeface: Typeface?, private var locale: Locale, private val db: NameDatabase, private val afav: FavoriteAdapter) : PagerAdapter() {
    ...
    override fun instantiateItem(collection: ViewGroup, position: Int): Any {
        ...
        text.setTextColor(resolveThemeColor(activity, android.R.attr.textColorPrimary))
        text.setBackgroundColor(resolveThemeColor(activity, android.R.attr.colorBackground))
