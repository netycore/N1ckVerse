...
internal class ListAdapter(activity: Activity, pref: SharedPreferences, db: NameDatabase, single: Boolean) : RecyclerUnicodeAdapter(activity, db, single) {
    ...
    override suspend fun instantiate(view: View): View {
        ...
        if (univer >= 700) {
            ...
            if (univer >= 1600) add(0x105C0, 0x105FF)
            add(0x10600, 0x1077F)
        ...
        if (univer >= 1600) add(0x10D40, 0x10D8F)
        add(0x10E60, 0x10E7F)
        ...
        if (univer >= 1200) add(0x10FE0, 0x10FFF)
        add(0x11000, 0x1107F)
        add(0x11080, 0x110CF)
        if (univer >= 610) {
            add(0x110D0, 0x110FF)
            ...
            if (univer >= 700) {
                ...
                add(0x112B0, 0x112FF)
                add(0x11300, 0x1137F)
                if (univer >= 1600) add(0x11380, 0x113FF)
            ...
            add(0x11680, 0x116CF)
            if (univer >= 1600) add(0x116D0, 0x116FF)
        ...
        if (univer >= 1600) add(0x13460, 0x143FF)
        if (univer >= 800) add(0x14400, 0x1467F)
        if (univer >= 1600) add(0x16100, 0x1613F)
        add(0x16800, 0x16A3F)
        if (univer >= 700) {
            add(0x16A40, 0x16A6F)
